...
def load_model():
    """
    Downloads the model if needed, then loads all ML models and returns them.
    """
    try:
        ...
        if not os.path.exists(model_path):
            print(f"'{model_name}' not found. Downloading from Google Drive to '{DATA_DIR}'...")
...
# --- CORE FUNCTIONS (These are correct and do not need changes) ---
